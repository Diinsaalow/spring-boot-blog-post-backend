...
public class UserService {
    ...
    public UserDTO updateUserProfile(Long userId, String email, String fullName, String profileImageUrl) {
    ...
    public UserDTO mapToDTO(User user) {
        return UserDTO.builder()
                ...
                .postIds(user.getPosts() != null ? 
                        user.getPosts().stream().map(post -> post.getId()).toList() : 
                        List.of())
                .build();
    }
} 